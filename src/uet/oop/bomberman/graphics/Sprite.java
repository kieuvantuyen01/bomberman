...
public class Sprite {
    ...
    public static Sprite bug = new Sprite(DEFAULT_SIZE, 8, 0, SpriteSheet.tiles, 16, 16);
    ...
    public static Sprite play2_up = new Sprite(DEFAULT_SIZE, 0, 12, SpriteSheet.tiles, 12, 16);
    public static Sprite play2_down = new Sprite(DEFAULT_SIZE, 2, 12, SpriteSheet.tiles, 12, 15);
    public static Sprite play2_left = new Sprite(DEFAULT_SIZE, 3, 12, SpriteSheet.tiles, 10, 15);
    public static Sprite play2_right = new Sprite(DEFAULT_SIZE, 1, 12, SpriteSheet.tiles, 10, 16);

    public static Sprite play2_up_1 = new Sprite(DEFAULT_SIZE, 0, 13, SpriteSheet.tiles, 12, 16);
    public static Sprite play2_up_2 = new Sprite(DEFAULT_SIZE, 0, 14, SpriteSheet.tiles, 12, 15);

    public static Sprite play2_down_1 = new Sprite(DEFAULT_SIZE, 2, 13, SpriteSheet.tiles, 12, 15);
    public static Sprite play2_down_2 = new Sprite(DEFAULT_SIZE, 2, 14, SpriteSheet.tiles, 12, 16);

    public static Sprite play2_left_1 = new Sprite(DEFAULT_SIZE, 3, 13, SpriteSheet.tiles, 11, 16);
    public static Sprite play2_left_2 = new Sprite(DEFAULT_SIZE, 3, 14, SpriteSheet.tiles, 12, 16);

    public static Sprite play2_right_1 = new Sprite(DEFAULT_SIZE, 1, 13, SpriteSheet.tiles, 11, 16);
    public static Sprite play2_right_2 = new Sprite(DEFAULT_SIZE, 1, 14, SpriteSheet.tiles, 12, 16);

    public static Sprite play2_dead1 = new Sprite(DEFAULT_SIZE, 4, 12, SpriteSheet.tiles, 14, 16);
    public static Sprite play2_dead2 = new Sprite(DEFAULT_SIZE, 5, 12, SpriteSheet.tiles, 13, 15);
    public static Sprite play2_dead3 = new Sprite(DEFAULT_SIZE, 6, 12, SpriteSheet.tiles, 16, 16);
    /*
    |--------------------------------------------------------------------------
    | Character
    |--------------------------------------------------------------------------
    ...
    //ONEAL
    public static Sprite oneal_right1 = new Sprite(DEFAULT_SIZE, 11, 0, SpriteSheet.tiles, 16, 16);
    public static Sprite oneal_right2 = new Sprite(DEFAULT_SIZE, 11, 1, SpriteSheet.tiles, 16, 16);
    public static Sprite oneal_right3 = new Sprite(DEFAULT_SIZE, 11, 2, SpriteSheet.tiles, 16, 16);

    public static Sprite oneal_left1 = new Sprite(DEFAULT_SIZE, 12, 0, SpriteSheet.tiles, 16, 16);
    public static Sprite oneal_left2 = new Sprite(DEFAULT_SIZE, 12, 1, SpriteSheet.tiles, 16, 16);
    public static Sprite oneal_left3 = new Sprite(DEFAULT_SIZE, 12, 2, SpriteSheet.tiles, 16, 16);
    ...
    //Kondoria
    public static Sprite kondoria_right1 = new Sprite(DEFAULT_SIZE, 10, 5, SpriteSheet.tiles, 16, 16);
    public static Sprite kondoria_right2 = new Sprite(DEFAULT_SIZE, 10, 6, SpriteSheet.tiles, 16, 16);
    public static Sprite kondoria_right3 = new Sprite(DEFAULT_SIZE, 10, 7, SpriteSheet.tiles, 16, 16);

    public static Sprite kondoria_left1 = new Sprite(DEFAULT_SIZE, 11, 5, SpriteSheet.tiles, 16, 16);
    public static Sprite kondoria_left2 = new Sprite(DEFAULT_SIZE, 11, 6, SpriteSheet.tiles, 16, 16);
    public static Sprite kondoria_left3 = new Sprite(DEFAULT_SIZE, 11, 7, SpriteSheet.tiles, 16, 16);
